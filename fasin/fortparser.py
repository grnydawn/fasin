...
f2003_grammar = parsergen.Grammar(
    r"""
        ...
        interface_stmt          = (_L interface_re (_1 generic_spec)? _CL) / (_L ~"ABSTRACT"i _1
                                  interface_re _CL)
        block_data_stmt         = _L block_re _0 data_re (_1 block_data_name)? _CL
        use_stmt                = (_L use_re ((_0 comma _0 module_nature)? _0 dcolons)? &(colon / _S) _0 module_name
                                  (_0 comma _0 rename_list )? _CL) /
                                  (_L use_re ((_0 comma _0 module_nature)? _0 dcolons)? &(colon / _S) _0 module_name
                                  _0 comma _0 ~"ONLY"i _0 colon (_0 only_list)? _CL)
        ...
        subroutine_stmt         = _L prefix? subroutine_re _1 subroutine_name (_0 lparen
                                  (_0 dummy_arg_list)? _0 rparen (_0 proc_language_binding_spec)?)? _CL
        enum_def_stmt           = _L enum_re _0 comma _0  ~"BIND"i _0 lparen _0 ~"C"i _0 rparen _CL
        ...
        select_type_stmt        = _L (select_construct_name _0 colon _0)? select_re _0 type_re _0 lparen
                                  (_0 associate_name _0 points)? _0 selector rparen
        select_case_stmt        = _L (case_construct_name _0 colon _0)? select_re _0 ~"CASE"i _0 lparen
                                  _0 case_expr _0 rparen
        case_stmt               = _L ~"CASE"i _1 case_selector (_0 case_construct_name)?
        associate_stmt          = _L (associate_construct_name _0 colon _0)? associate_re _0 lparen _0
                                  association_list _0 rparen
        procedure_declaration_stmt= _L ~"PROCEDURE"i _0 lparen (_0 proc_interface )? _0 rparen ((_0 comma _0
                                  proc_attr_spec )* _0 dcolons)? _0 proc_decl_list _CL
        import_stmt             = _L ~"IMPORT"i ((_0 dcolons)? &(colon / _S) _0 import_name_list )? _CL
        access_stmt             = _L access_spec ((_0 dcolons)? &(colon / _S) _0 access_id_list )? _CL
        allocatable_stmt        = _L ~"ALLOCATABLE"i (_0 dcolons )? &(colon / _S) _0 object_name
                                  (_0 lparen _0 deferred_shape_spec_list _0 rparen)? (_0 comma _0 object_name
                                  (_0 lparen _0 deferred_shape_spec_list _0 rparen)?)* _CL
        asynchronous_stmt       = _L asynchronous_re (_0 dcolons)? &(colon / _S) _0 object_name_list _CL
        bind_stmt               = _L language_binding_spec (_0 dcolons)? &(colon / _S) _0 bind_entity_list _CL
        common_stmt             = _L ~"COMMON"i (_1 slash (_0 common_block_name )? _0 slash)? _0
                                  common_block_object_list ((_0 comma )? _0 slash (_0 common_block_name )?
                                  _0 slash _0 common_block_object_list)* _CL
        data_stmt               = _L data_re _1 data_stmt_set ( (_0 comma)? _0 data_stmt_set )*
        dimension_stmt          = _L ~"DIMENSION"i (_0 dcolons)? &(colon / _S) _0 array_name _0 lparen _0
                                  array_spec _0 rparen (_0 comma _0 array_name _0 lparen _0 array_spec _0 rparen)* _CL
        equivalence_stmt        = _L ~"EQUIVALENCE"i _0 equivalence_set_list
        external_stmt           = _L ~"EXTERNAL"i (_0 dcolons)? &(colon / _S) _0 external_name_list _CL
        intent_stmt             = _L intent_re _0 lparen _0 intent_spec _0 rparen (_0 dcolons)? &(colon / _S)
                                  _0 dummy_arg_name_list _CL
        intrinsic_stmt          = _L ~"INTRINSIC" (_0 dcolons)? &(colon / _S) _0 intrinsic_procedure_name_list _CL
        namelist_stmt           = _L ~"NAMELIST"i _0 slash _0 namelist_group_name _0 slash _0 namelist_group_object_list
                                  ((_0 comma )? _0 slash _0 namelist_group_name _0 slash _0 namelist_group_object_list)* _CL
        optional_stmt           = _L ~"OPTIONAL"i (_0 dcolons)? &(colon / _S) _0 dummy_arg_name_list _CL
        pointer_stmt            = _L pointer_re (_0 dcolons)? &(colon / _S) _0 pointer_decl_list _CL
        protected_stmt          = _L ~"PROTECTED"i (_0 dcolons)? &(colon / _S) _0 entity_name_list _CL
        save_stmt               = _L save_re ((_0 dcolons)? &(colon / _S) _0 saved_entity_list)? _CL
        target_stmt             = _L ~"TARGET"i (_0 dcolons)? &(colon / _S) _0 object_name (_0 lparen _0
                                  array_spec _0 rparen)? (_0 comma _0 object_name (_0 lparen _0 array_spec _0 rparen)?)* _CL
        volatile_stmt           = _L ~"VOLATILE"i (_0 dcolons)? &(colon / _S) _0 object_name_list _CL
        value_stmt              = _L ~"VALUE"i (_0 dcolons)? &(colon / _S) _0 dummy_arg_name_list _CL
        ...
        call_stmt               = _L ~"CALL"i _1 procedure_designator (_0 lparen (_0 actual_arg_spec_list )? _0 rparen)? _CL
        ...
        deallocate_stmt         = _L ~"DEALLOCATE"i _0 lparen _0 allocate_object_list (_0 comma _0 dealloc_opt_list)? _0 rparen _CL
        exit_stmt               = _L ~"EXIT"i (_0 do_construct_name)? _CL
        flush_stmt              = (_L ~"FLUSH"i _0 file_unit_number _CL) / (_L ~"FLUSH"i _0 lparen _0 flush_spec_list _0 rparen _CL)
        ...
        pointer_assignment_stmt = (_L proc_pointer_object _0 points _0 proc_target _CL) /
                                  (_L data_pointer_object (_0 lparen _0 bounds_spec_list _0 rparen)? _0 points
                                  _0 data_target _CL) / (_L data_pointer_object _0 lparen _0
        ...
        read_stmt               = (_L ~"READ"i _0 lparen _0 io_control_spec_list _0 rparen (_0 input_item_list)? _CL) /
                                  (_L ~"READ"i _1 format (_0 comma _0 input_item_list)? _CL)
        ...
        write_stmt              = _L ~"WRITE"i _0 lparen _0 io_control_spec_list _0 rparen (_0 output_item_list)?
        arithmetic_if_stmt      = _L if_re _0 lparen _0 scalar_numeric_expr _0 rparen _0 label _0 comma
                                  _0 label _0 comma _0 label _CL
        computed_goto_stmt      = _L ~"GO"i _0 ~"TO"i _0 lparen _0 label_list _0 rparen (_0 comma)? _0 scalar_int_expr _CL
        stmt_function_stmt      = _L function_name _0 lparen (_0 dummy_arg_name_list )? _0 rparen _0 equal _0 scalar_expr _CL
        type_declaration_stmt   = _L declaration_type_spec ((_0 comma _0 attr_spec )* _0 dcolons )?
                                  &(colon / _S) _0 entity_decl_list _CL
        parameter_stmt          = _L ~"PARAMETER"i _0 lparen _0 named_constant_def_list _0 rparen _CL
        format_stmt             = _L ~"FORMAT"i _0 format_specification _CL
        entry_stmt              = _L ~"ENTRY"i _0 entry_name (_0 lparen (_0 dummy_arg_list)? _0 rparen (_0 suffix)?)? _CL
        procedure_stmt          = _L (module_re _1)? ~"PROCEDURE"i _1 procedure_name_list _CL
        ...
        proc_component_def_stmt = _L ~"PROCEDURE"i _0 lparen (_0 proc_interface)? _0 rparen _0 comma _0
        ...
        type_guard_stmt         = (_L type_re _1 ~"IS"i _0 lparen _0 type_spec _0 rparen (_0 select_construct_name)? _CL)
                                  ...
                                  (_0 select_construct_name)? _CL) / (_L class_re _1 ~"DEFAULT"i
        ...
        type_attr_spec          = access_spec / (~"EXTENDS"i _0 lparen _0 parent_type_name _0 rparen) /
                                  ~"ABSTRACT"i / (~"BIND"i _0 lparen _0 "C" _0 rparen)
        type_param_attr_spec    = kind_re /len_re
        type_param_decl         = type_param_name (_0 equal _0 scalar_int_initialization_expr )?
        component_attr_spec     = pointer_re / (~"DIMENSION"i _0 lparen _0 component_array_spec _0 rparen) /
                                  ~"ALLOCATABLE"i / access_spec
        component_array_spec    = explicit_shape_spec_list / deferred_shape_spec_list
        proc_component_attr_spec= pointer_re / (~"PASS"i ( _0 lparen _0 arg_name _0 rparen)?) /
                                  ~"NOPASS"i / access_spec
        generic_spec            = (~"ASSIGNMENT"i _0 lparen _0 equal _0 rparen) /
                                  (~"OPERATOR"i _0 lparen _0 defined_operator _0 rparen) /
                                  dtio_generic_spec / generic_name
        dtio_generic_spec       = (~"READ"i _0 lparen _0 ~"FORMATTED"i _0 rparen) /
                                  (~"READ"i _0 lparen _0 ~"UNFORMATTED"i _0 rparen) /
                                  (~"WRITE"i _0 lparen _0 ~"FORMATTED"i _0 rparen) /
                                  (~"WRITE"i _0 lparen _0 ~"UNFORMATTED"i _0 rparen)
        io_control_spec         = (~"ADVANCE"i _0 equal _0 scalar_default_char_expr) /
                                  (asynchronous_re _0 equal _0 scalar_char_initialization_expr) /
                                  (~"BLANK"i _0 equal _0 scalar_default_char_expr) /
                                  (~"DECIMAL"i _0 equal _0 scalar_default_char_expr) /
                                  (~"DELIM"i _0 equal _0 scalar_default_char_expr) /
                                  (end_re _0 equal _0 label) / (~"EOR"i _0 equal _0 label) /
                                  (err_re _0 equal _0 label) /  (~"ID"i _0 equal _0 scalar_int_variable) /
                                  (iomsg_re _0 equal _0 iomsg_variable) /
                                  (~"IOSTAT"i _0 equal _0 scalar_int_variable) /
                                  (~"PAD"i _0 equal _0 scalar_default_char_expr) /
                                  (~"POS"i _0 equal _0 scalar_int_expr) /
                                  (~"REC"i _0 equal _0 scalar_int_expr) /
                                  (~"ROUND"i _0 equal _0 scalar_default_char_expr) /
                                  (sign_re _0 equal _0 scalar_default_char_expr) /
                                  (~"SIZE"i _0 equal _0 scalar_int_variable) /
                                  ((unit_re _0 equal _0)? io_unit) / ((~"FMT"i _0 equal _0)? format) /
                                  ((~"NML"i _0 equal _0)? namelist_group_name)
        array_spec              = explicit_shape_spec_list / assumed_shape_spec_list /
                                  deferred_shape_spec_list / assumed_size_spec
        attr_spec               = access_spec / ~"ALLOCATABLE"i / asynchronous_re /
                                  (~"DIMENSION"i _0 lparen _0 array_spec _0 rparen) / ~"EXTERNAL"i /
                                  (intent_re _0 lparen _0 intent_spec _0 rparen) / ~"INTRINSIC"i /
                                  language_binding_spec / ~"OPTIONAL"i / ~"PARAMETER"i /
                                  pointer_re / ~"PROTECTED"i / save_re/ ~"TARGET"i /
                                  ~"VALUE"i / ~"VOLATILE"i
        ...
        language_binding_spec   = ~"BIND"i _0 lparen _0 "C" (_0 comma _0 ~"NAME"i _0 equal _0
        ...
        position_spec           = (iomsg_re _0 equal _0 iomsg_variable) / (~"IOSTAT"i _0 equal _0 scalar_int_variable) /
                                  (err_re _0 equal _0 label) / ((unit_re _0 equal _0)? file_unit_number)
        wait_spec               = (end_re _0 equal _0 label) / (~"EOR"i _0 equal _0 label) /
                                  (err_re _0 equal _0 label) / (~"ID"i _0 equal _0 scalar_int_expr) /
                                  (iomsg_re _0 equal _0 iomsg_variable) / (~"IOSTAT"i _0 equal _0 scalar_int_variable) /
                                  ((unit_re _0 equal _0)? file_unit_number)
        flush_spec              = (~"IOSTAT"i _0 equal _0 scalar_int_variable) /
                                  (iomsg_re _0 equal _0 iomsg_variable) / (err_re _0 equal _0 label) /
                                  ((unit_re _0 equal _0)? file_unit_number)
        close_spec              = (~"IOSTAT"i _0 equal _0 scalar_int_variable) /
                                  (iomsg_re _0 equal _0 iomsg_variable) / (err_re _0 equal _0 label) /
                                  (status_re _0 equal _0 scalar_default_char_variable)
        allocate_shape_spec     = (lower_bound_expr _0 colon _0)? upper_bound_expr

        connect_spec            = (~"ACCESS"i _0 equal _0 scalar_default_char_expr) / (~"ACTION"i _0 equal _0 scalar_default_char_expr)
                                  /(asynchronous_re _0 equal _0 scalar_default_char_expr)
                                  /(~"BLANK"i _0 equal _0 scalar_default_char_expr) / (~"DECIMAL"i _0 equal _0 scalar_default_char_expr)
                                  /(~"DELIM"i _0 equal _0 scalar_default_char_expr) / (~"ENCODING"i _0 equal _0 scalar_default_char_expr)
                                  /(err_re _0 equal _0 label) /(~"FILE"i _0 equal _0 file_name_expr)
                                  /(~"FORM"i _0 equal _0 scalar_default_char_expr) / (iomsg_re _0 equal _0 iomsg_variable)
                                  /(~"IOSTAT"i _0 equal _0 scalar_int_variable) / (~"PAD"i _0 equal _0 scalar_default_char_expr)
                                  /(~"POSITION"i _0 equal _0 scalar_default_char_expr) / (~"RECL"i _0 equal _0 scalar_int_expr)
                                  /(~"ROUND"i _0 equal _0 scalar_default_char_expr) / (sign_re _0 equal _0 scalar_default_char_expr)
                                  /(status_re _0 equal _0 scalar_default_char_expr) / ((unit_re _0 equal _0)? file_unit_number)
        ...
        case_selector           = ~"DEFAULT"i / (lparen _0 case_value_range_list _0 rparen)
        ...
        rename                  = (local_name _0 points _0 use_name) / (~"OPERATOR"i _0 lparen _0
                                  local_defined_operator _0 rparen _0 points ~"OPERATOR"i _0 lparen _0
                                  use_defined_operator _0 rparen)
        only                    = generic_spec / rename / only_use_name
        prefix                  = (prefix_spec _1)+
        suffix                  = (proc_language_binding_spec (_1 ~"RESULT"i _0 lparen _0
                                  result_name _0 rparen)?) / (~"RESULT"i _0 lparen _0
        ...
        specific_binding        = ~"PROCEDURE"i (_0 lparen _0 interface_name _0 rparen)? ((_0 comma _0
                                  binding_attr_list)? _0 dcolons _0)? &(colon / _S / rparen) binding_name (_0 points _0 procedure_name)?
        binding_attr            = (~"PASS"i (_0 lparen _0 arg_name _0 rparen)?) / ~"NOPASS"i / ~"NON_OVERRIDABLE"i /
                                  ~"DEFERRED"i / access_spec
        generic_binding         = ~"GENERIC"i (_0 comma _0 access_spec _0)? dcolons _0 generic_spec _0 points _0
                                  binding_name_list
        final_binding           = ~"FINAL"i (_0 dcolons)? &(colon / _S) _0 final_subroutine_name_list
        ...
        loop_control            = ((comma _0)? do_variable _0 equal _0 scalar_int_expr _0
                                  ...
                                  ((comma _0)? ~"WHILE"i _0 lparen _0 scalar_logical_expr _0 rparen)
...
#        format                  = star / default_char_expr / label
        ...
        logical_literal_constant= (true_re ("_" kind_param)?) / (false_re ("_" kind_param)?)
