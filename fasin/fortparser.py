...
f2003_grammar = Grammar(
    r"""
        ...
        ################## constructs and type definition ###################
        if_construct            = "$"
        ...
        end_type_stmt           = _0 ~"END"i _0 ~"TYPE"i (_0 type_name )?
        exit_stmt               = "$"
        flush_stmt              = "$"
        forall_stmt             = "$"
        goto_stmt               = "$"
        ...
        final_binding           = ~"FINAL"i "::"? final_subroutine_name_list
        ...
        proc_component_attr_spec_list = proc_component_attr_spec (_0 "," _0 proc_component_attr_spec)*
        ...
        final_subroutine_name_list = final_subroutine_name (_0 "," _0 final_subroutine_name)*
